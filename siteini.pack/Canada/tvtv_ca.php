...
if ($reqtype == '1') {
        ...
        $dataid = $_GET['dataid'];
        $date = $_GET['date'];
        $url = "https://tvtv.ca/tvm/t/tv/v4/lineups/" . $dataid . "/listings/grid?detail=%27brief%27&start=" . $date . "T00:00Z&end=" . $date . "T23:59Z&startchan=" . $channel . "&endchan=". $channel . "";
        ...
        $dataid = $_GET['dataid'];
        $url = "https://tvtv.ca/tvm/t/tv/v4/lineups/" . $dataid . "";
